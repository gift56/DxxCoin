        ...
        <div className="flex items-center justify-center flex-col w-full gap-16 py-10 ">
          ...
          <div className="flex flex-col w-full gap-10">
            <div className="w-full flex md:flex-row flex-col justify-between items-start">
              <div className="flex-1 relative after:content-[''] after:absolute after:top-[-12px] after:right-[8%] after:w-[100px] after:h-[115%] after:border-t-[3px] after:border-b-[3px] after:border-r-[3px] after:rounded-lg after:border-[#17F948] -z-10">
                <div className="border-[#00ff3775] rounded-lg p-4 pb-6 flex flex-col items-center justify-center border gap-4 w-[90%] relative  z-10 bg-[#021f08]">
            ...
            <div className="w-full flex md:flex-row flex-col justify-between items-start">
              <div className="flex-1 relative after:content-[''] after:absolute after:top-[-12px] after:right-[8%] after:w-[100px] after:h-[115%] after:border-t-[3px] after:border-b-[3px] after:border-r-[3px] after:rounded-lg after:border-[#17F948] -z-10 mt-[10px]">
                <div className="border-[#00ff3775] rounded-lg p-4 pb-6 flex flex-col items-center justify-center border gap-4 w-[90%] relative  z-10 bg-[#021f08]">
                  <h1 className="text-xl font-medium">January</h1>
                  <div className="flex flex-col gap-2 items-start justify-start w-full">
                    <h2 className="text-2xl font-semibold text-white">Brief</h2>
